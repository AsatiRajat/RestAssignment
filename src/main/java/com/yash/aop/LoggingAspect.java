...
public class LoggingAspect {
	...
	@Pointcut(value = "execution(* com.yash.controller.EmployeeController.*(..))")
	public void method1() {
	}

	@Pointcut(value = "execution(* com.yash.service.EmployeeService.*(..))")
	public void method2() {
	}
...
//	@Around("method1() or method2()")
//	public void around(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
//		long startTime = System.currentTimeMillis();
//
//		logger.info("==========LoggingAspect around called.==========");
//		logger.info("Method name : " + proceedingJoinPoint.getSignature().getName());
//		logger.info("Number of method args : " + proceedingJoinPoint.getArgs().length);
